...
const enddateinfo = process.env.BOOKING_CONFIRMATION_EMAIL_SUBJECT_ADDL_ENDA_DATE;
const sendConfirmation = (req_1, res_1, ...args_1) => __awaiter(void 0, [req_1, res_1, ...args_1], void 0, function* (req, res, retries = 5, delay = 1000) {
    ...
    let body = subject.concat(tourmanagername).concat(additionalInfo).concat(startdateinfo).
        concat(startDate).
